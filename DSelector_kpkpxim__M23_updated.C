...
#include "DSelector_kpkpxim__M23_updated.h"

void DSelector_kpkpxim__M23_updated::Init(TTree *locTree)
{
	...
	dOutputFileName = "kpkpxim__M23_updated.root"; //"" for none
...
Bool_t DSelector_kpkpxim__M23_updated::Process(Long64_t locEntry)
{
...
void DSelector_kpkpxim__M23_updated::Finalize(void)
{

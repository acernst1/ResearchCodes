...
void DSelector_thrown_kpkpxim::Init(TTree *locTree)
{
	...
	dHist_Egamma_t_acc = new TH2F("Egamma_t_acc","; E_{#gamma} (GeV); -t (GeV/c)^{2}",180, 3.0, 12.0,1000, 0.0, 5.0);
	dHist_Egamma_t_063 = new TH2F("Egamma_t","; E_{#gamma} (GeV); -t (GeV/c)^{2}",112, 6.3, 11.9,1000, 0.0, 5.0);
	dHist_Egamma_t_063_acc = new TH2F("Egamma_t_acc","; E_{#gamma} (GeV); -t (GeV/c)^{2}",112, 6.3, 11.9,1000, 0.0, 5.0);
	dHist_Egamma_t_064 = new TH2F("Egamma_t","; E_{#gamma} (GeV); -t (GeV/c)^{2}",112,6.4, 12.0,1000, 0.0, 5.0);
	dHist_Egamma_t_064_acc = new TH2F("Egamma_t_acc","; E_{#gamma} (GeV); -t (GeV/c)^{2}",112,6.4, 12.0,1000, 0.0, 5.0);
	dHist_Egamma_t_065 = new TH2F("Egamma_t","; E_{#gamma} (GeV); -t (GeV/c)^{2}",112,6.5,12.1,1000, 0.0, 5.0);
	dHist_Egamma_t_065_acc = new TH2F("Egamma_t_acc","; E_{#gamma} (GeV); -t (GeV/c)^{2}",112,6.5,12.1,1000, 0.0, 5.0);

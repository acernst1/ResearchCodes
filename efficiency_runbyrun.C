...
{
    int numRuns=407; //2017-01 is 347, 2018-01 is 486, 2018-08 is 407
    double minVal=6.4;
    double maxVal=11.4;
    double tagged=1.0;
...
*/
	...
	{
    int run = Runs[i];
    sprintf(mcFilePath, "/cache/halld/home/acernst/MC/2018-08_ANAver02/root/kpkpxim__B4_M23_2018-08_ANAver02_%5d.root", run);
    sprintf(thrownFilePath, "/cache/halld/home/acernst/MC/2018-08_ANAver02/thrown/tree_thrown_genr8_%06d.root", run);

...
class DSelector_kpkpxim_wf : public DSelector
{
	public:

		DSelector_kpkpxim_wf(TTree* locTree = NULL) : DSelector(locTree){}
		virtual ~DSelector_kpkpxim_wf(){}
	...
	ClassDef(DSelector_kpkpxim_wf, 0);
};

void DSelector_kpkpxim_wf::Get_ComboWrappers(void)
{
	//Step 0

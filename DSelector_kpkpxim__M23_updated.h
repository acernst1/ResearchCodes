...
#ifndef DSelector_kpkpxim__M23_updated_h
#define DSelector_kpkpxim__M23_updated_h
...
class DSelector_kpkpxim__M23_updated : public DSelector
{
	public:

		DSelector_kpkpxim__M23_updated(TTree* locTree = NULL) : DSelector(locTree){}
		virtual ~DSelector_kpkpxim__M23_updated(){}
	...
	ClassDef(DSelector_kpkpxim__M23_updated, 0);
};

void DSelector_kpkpxim__M23_updated::Get_ComboWrappers(void)
{
	//Step 0
...
#endif // DSelector_kpkpxim__M23_updated_h
